            ...
            <form onSubmit={handleSubmit}>
                <div className="relative group">
                    ...
                    <input
                        ref={inputRef}
                        type="search"
                        className="block w-full p-4 pl-12 pr-24 text-base text-gray-900 bg-white border-2 border-transparent focus:border-accent-yellow outline-none transition-all shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] focus:shadow-[4px_4px_0px_0px_#FFD300] [&::-webkit-search-cancel-button]:appearance-none"
